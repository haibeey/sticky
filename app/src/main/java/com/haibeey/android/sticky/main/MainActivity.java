...
import com.haibeey.android.sticky.NoteAdd.NoteAddActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AsyncTask<Void, Void, ArrayList<Note>>() {
            ...
            protected ArrayList<Note> doInBackground(Void... voids) {
                ...
                ArrayList<Note> notes=dataBase.queryAllNotes();
                return notes;
            }
            ...
            protected void onPostExecute(ArrayList<Note> notes) {
                ...
                recyclerView.setAdapter(new NoteAdapter(notes,MainActivity.this));
            }
        }.execute();
    }
